...
@RestController
@RequestMapping("/transaction_label")
...
//        return ResponseEntity.badRequest().build();
    ...
    @DeleteMapping("/{transactionLabelId}")
    ...
    @PutMapping("/addTransactionLabel")
    ...
    @DeleteMapping("/removeTransactionLabel")
