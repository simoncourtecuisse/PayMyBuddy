...
//
//
//import com.payMyBuddy.config.UserDetailsServiceImpl;
...
//
//    Logger LOGGER = LogManager.getLogger(UserViewController.class);
//
//    @Autowired
...
//    public String showSignUpForm(@ModelAttribute User user, Model model, RedirectAttributes redirectAtt) {
//        String signupError = null;
//        Optional<User> existUser = userService.getUserByEmail(user.getEmail());
...
//
//        if (signupError == null) {
//            redirectAtt.addFlashAttribute("message", "Successful Signup, please login !");
...
//    public String error(HttpServletRequest servletRequest) {
