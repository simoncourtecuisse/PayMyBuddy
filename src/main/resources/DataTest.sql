INSERT INTO paymybuddytest.user (id, firstname, lastname, email, password, balance)
...
INSERT INTO paymybuddytest.contact(user_id, friend_user_id)
VALUES (1, 2),
       (1, 3),
       (2, 3),
       (4, 1);

INSERT INTO paymybuddytest.bank_account (id, user_id, iban)
VALUES (1, 1, '232625'),
       (2, 2, '685137'),
       (3, 3, '809572'),
       (4, 4, '158338');

INSERT INTO paymybuddytest.transaction_label (id, description)
...
INSERT INTO paymybuddytest.transaction (id, transaction_label_id, creditor_id, debtor_id, amount, commission, date)
